...
third-derivative convergence must therefore be measured, as in the
manufactured test below. Projection alone is not a proof of their convergence.
...
require the recorded quadrature and refinement checks. This solution-space
