...
\label{chap:ofdg}
The DG state from \cref{chap:methods} may contain unresolved oscillations.
...
not the physical-speed setting used in this preview.
...
a caller that wants a semidiscrete term. The preview uses the exponential
