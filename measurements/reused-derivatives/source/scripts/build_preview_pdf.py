...
def main():
    ...
    reused_directory = ROOT / 'measurements/reused-derivatives'
    if (reused_directory / 'summary.json').exists():
        from reused_derivative_pages import append_reused_pages
        append_reused_pages(story, reused_directory, styles)
