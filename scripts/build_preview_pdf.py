#!/usr/bin/env python3
"""Build a six-page discussion brief from the measured preview dataset."""
import argparse
import json
...
def main():
    ...
    table([
        ...
        ['Later', 'No result here requires a giant test to interpret.', 'Defer blast waves, 3D, and scaling studies until the scientific question and hardware are chosen.'],
    ], [45, 224, 235])
