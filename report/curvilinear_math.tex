...
An alternative that differentiates the original mapped function without
intermediate projection is derived in \cref{sec:appendix-direct}. That isolated
experiment does not replace the recursive method described here.
