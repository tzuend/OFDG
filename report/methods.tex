\chapter{From finite elements to discontinuous Galerkin}
\label{chap:methods}
...
We first explain this communication, then the time update that the filters modify.
...
\subsection{A labelled example: linear advection}
...
\emph{stages}. The preview uses classical fourth-order RK (RK4), with a CFL
...
\cite{CockburnShu1998,GottliebShu1998}. In this work, adapted OFDG is normally
...
volume, $p$ pressure, and $\gamma=1.4$ the ratio of specific heats in the tests.
