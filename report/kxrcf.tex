...
matrix, so affine two-dimensional meshes may mix triangles and quadrilaterals
at one polynomial order.
...
geometry support is currently verified only for two-dimensional triangles and
quadrilaterals.  Its radius generalization,
